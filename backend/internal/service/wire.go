...
func ProvideSettingService(settingRepo SettingRepository, groupRepo GroupRepository, proxyRepo ProxyRepository, cfg *config.Config) *SettingService {
	...
	if err := svc.LoadEcosystemSettings(context.Background()); err != nil {
		logger.LegacyPrintf("service.setting", "Warning: load ecosystem settings failed: %v", err)
	}
...
var ProviderSet = wire.NewSet(
	// Core services
	ProvideEcosystemTokenVerifier,
	ProvideEcosystemGroupProvider,
	ProvideEcosystemModelProvider,
	NewEcosystemService,
	ProvideAuthService,
	NewPasskeyService,
	NewUserService,
