...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		EcosystemIssuerURL:                                     settings.EcosystemIssuerURL,
		EcosystemAudience:                                      settings.EcosystemAudience,
		EcosystemJWKSURL:                                       settings.EcosystemJWKSURL,
		EcosystemAllowedClientIDs:                              settings.EcosystemAllowedClientIDs,
		EcosystemPublicGatewayURL:                              settings.EcosystemPublicGatewayURL,
		EcosystemAllowedSigningAlgs:                            settings.EcosystemAllowedSigningAlgs,
		EcosystemClockSkewSeconds:                              settings.EcosystemClockSkewSeconds,
		EcosystemJWKSRequestTimeoutSeconds:                     settings.EcosystemJWKSRequestTimeoutSeconds,
		EcosystemJWKSMaxResponseBytes:                          settings.EcosystemJWKSMaxResponseBytes,
		EcosystemJWKSCacheTTLSeconds:                           settings.EcosystemJWKSCacheTTLSeconds,
		EcosystemJWKSRefreshMinIntervalSeconds:                 settings.EcosystemJWKSRefreshMinIntervalSeconds,
		EcosystemRateLimitPerMinute:                            settings.EcosystemRateLimitPerMinute,
