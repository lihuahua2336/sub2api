...
export interface SystemSettings {
  ...
  ecosystem_issuer_url: string;
  ecosystem_audience: string;
  ecosystem_jwks_url: string;
  ecosystem_allowed_client_ids: string;
  ecosystem_public_gateway_url: string;
  ecosystem_allowed_signing_algs: string;
  ecosystem_clock_skew_seconds: number;
  ecosystem_jwks_request_timeout_seconds: number;
  ecosystem_jwks_max_response_bytes: number;
  ecosystem_jwks_cache_ttl_seconds: number;
  ecosystem_jwks_refresh_min_interval_seconds: number;
  ecosystem_rate_limit_per_minute: number;
